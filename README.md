1- The script of the project is contained in the file "llm-detect-ai-generated-text.ipynb".
...
In the branch **Sentiment Analysis** there is a synthetic but very interesting sentiment analysis by using the same dataframe 'train_essays.csv'
